...
scripts. The "validator" is STYLE\_GUIDE.md, and Claude performs the check by
...
messages like "Field 'signature\_date' not found. Available fields:
customer\_name, order\_total, signature\_date\_signed" to help Claude fix
issues.
