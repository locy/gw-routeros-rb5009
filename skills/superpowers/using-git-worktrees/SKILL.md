...
linked worktree. Skip to Step 3 (Project Setup). Do NOT create another worktree.
...
consent, work in place and skip to Step 3.
...
4. **If there is no other guidance available**, default to `.worktrees/` at the
   project root.
...
- **Fix:** Follow priority: existing > global legacy > instruction file >
  default
...
- Follow directory priority: existing > global legacy > instruction file >
  default
